...
app = FastAPI(openapi_url="/api/v1/languages/openapi.json", docs_url="/api/v1/languages/docs")
...
app.include_router(languages, prefix='/api/v1/languages', tags=['languages'])